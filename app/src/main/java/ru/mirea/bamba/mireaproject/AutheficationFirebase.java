...
import ru.mirea.bamba.mireaproject.databinding.ActivityAutheficationFirebaseBinding;

public class AutheficationFirebase extends AppCompatActivity{
    private static final String TAG = MainActivity.class.getSimpleName();
    private ActivityAutheficationFirebaseBinding binding;
    // START declare_auth
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAutheficationFirebaseBinding.inflate(getLayoutInflater());
        ...
        binding.homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AutheficationFirebase.this, MainActivity.class);
                startActivity(i);
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AutheficationFirebase.this, "Authentication failed.",
        ...
        Objects.requireNonNull(user).sendEmailVerification()
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(AutheficationFirebase.this,
