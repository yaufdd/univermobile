...
import ru.mirea.bamba.mireaproject.databinding.FragmentFirebase2Binding;
...
public class FirebaseFragment extends Fragment {
    private FragmentFirebase2Binding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFirebase2Binding.inflate(inflater,container,false);
        View v = binding.getRoot();

        Intent intent = new Intent(getContext(), AutheficationFirebase.class);
