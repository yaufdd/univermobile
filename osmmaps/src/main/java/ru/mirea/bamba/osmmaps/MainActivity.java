package ru.mirea.bamba.osmmaps;
...
import ru.mirea.bamba.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Государственная дума",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Зимний дворец",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
